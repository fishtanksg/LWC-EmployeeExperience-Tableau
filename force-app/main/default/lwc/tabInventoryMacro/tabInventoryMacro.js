...
export default class HeadcountDashboard extends LightningElement {
    ...
    initViz () { 
        ...
        const url = "https://dub01.online.tableau.com/t/madhavpersonalsite/views/tabEE/inventory-micro?:showAppBanner=false&:display_count=n&:showVizHome=n&:origin=viz_share_link&:linktarget=_parent";
        const options = {
            hideTabs: true,
            hideToolbar: true,
    ...
    onMarksSelection(marksEvent) {
        const fields = {};
        fields[SUBJECT_FIELD.fieldApiName] = "TableauTest";
